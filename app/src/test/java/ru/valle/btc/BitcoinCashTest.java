...
public final class BitcoinCashTest extends TestCase {
    ...
    public void testBip143Hash1() throws BitcoinException {
        Transaction unsignedTx = Transaction.decodeTransaction(BTCUtils.fromValidHex("0100000002fff7f7881a8099afa6940d42d1e7f6362bec38171ea3edf433541db4e4ad969f0000000000eeffffffef" +
        ...
        Transaction.Script spendScript = new Transaction.Script(BTCUtils.fromValidHex("76a9141d0f172a0ecb48aee1be1f2687d2963ae33f71a188ac"));
    ...
    public void testBip143Hash2() throws BitcoinException {
        Transaction unsignedTx = Transaction.decodeTransaction(BTCUtils.fromValidHex("0100000001db6b1b20aa0fd7b23880be2ecbd4a98130974cf4748fb66092ac4d3ceb1a54770100000000feffffff02b8b4eb" +
        ...
        Transaction.Script spendScript = new Transaction.Script(BTCUtils.fromValidHex("76a91479091972186c449eb1ded22b78e40d009bdf008988ac"));
    ...
    public void testBip143Hash3() throws BitcoinException {
        Transaction unsignedTx = Transaction.decodeTransaction(BTCUtils.fromValidHex("0100000002fe3dc9208094f3ffd12645477b3dc56f60ec4fa8e6f5d67c565d1c6b9216b36e0000000000ffffffff0815cf" +
        ...
        assertArrayEquals(BTCUtils.fromValidHex("82dde6e4f1e94d02c2b7ad03d2115d691f48d064e9d52f58194a6637e4194391"), sigHash2);
        ...
        byte[] sigHash1 = Transaction.Script.bip143Hash(1, unsignedTx, Transaction.Script.SIGHASH_SINGLE, spendScriptSecond.bytes,
                BTCUtils.parseValue("49"));
        assertArrayEquals(BTCUtils.fromValidHex("fef7bd749cce710c5c052bd796df1af0d935e59cea63736268bcbe2d2134fc47"), sigHash1);
    }
...
//        https://www.blocktrail.com/tBCC/address/mymHGRN9LhQHqPLobnR1fkeHMzLbmN9rZV/transactions
        ...
        byte[] txWithUnspentOutputBytes = BTCUtils.fromValidHex("01000000012a73a98db5c1b223d87d42520f122383a161b17c5378ecee72095a2128f41f3a000000008b4830450221" +
...
//        System.out.println(BTCUtils.toHex(tx.getBytes()));
        ...
        txWithUnspentOutputBytes = BTCUtils.fromValidHex("0100000001ac8d7ee0eb81b91e19b2d1c9966b451dc72e7a3529cd646aef74d81384a3f5c2000000008a4730440" +
